...
public class CategoryServiceImpl implements CategoryService
{
    ...
    @Override
    public CategoryView update(CategoryForm categoryForm)
    {
        if (categoryForm == null) throw new IllegalArgumentException("Category Form object was null");

        Category updatedCategory = repository.save(new Category(categoryForm.getId(), categoryForm.getName(), LocalDate.now()));

        CategoryView categoryView = converter.toView(updatedCategory);
